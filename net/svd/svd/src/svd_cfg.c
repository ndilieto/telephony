...
#define CONF_CODEC_ALAW "mLaw"
#define CONF_CODEC_MLAW "aLaw"
...
{/*{{{*/
	...
	i=cod_type_MLAW-CODEC_BASE;
	g_conf.cp[i].type = cod_type_MLAW;
	g_conf.cp[i].sdp_name=strdup("PCMU");
	g_conf.cp[i].fmtp_str=empty;
	...
	*/
	...
	g_conf.codecs[cod_type_MLAW].type=cod_type_MLAW;
	g_conf.codecs[cod_type_MLAW].pkt_size=cod_pkt_size_20;
	g_conf.codecs[cod_type_MLAW].bpack=bitpack_RTP;
	g_conf.codecs[cod_type_MLAW].user_payload=0;
	g_conf.codecs[cod_type_MLAW].jb.jb_type=jb_type_FIXED;
	g_conf.codecs[cod_type_MLAW].jb.jb_loc_adpt=jb_loc_adpt_OFF;
	g_conf.codecs[cod_type_MLAW].jb.jb_scaling=1.4*16;
	g_conf.codecs[cod_type_MLAW].jb.jb_init_sz=120*8;
	g_conf.codecs[cod_type_MLAW].jb.jb_min_sz=10*8;
	g_conf.codecs[cod_type_MLAW].jb.jb_max_sz=200*8;
